...
public class TemperatureLSTM {
    private static final Logger LOGGER = LoggerFactory.getLogger(TemperatureLSTM.class);

    //private static File baseDir = new File("train");
    ...
    public static void main(String[] args) throws Exception {
        ...
        File baseDir = new ClassPathResource("temperatureSingle").getFile();
        ...
        trainReader.initialize(new NumberedFileInputSplit(baseDir.getAbsolutePath() + "/twoColumnBuangOutlierSmallTrain%d.csv", 0, 0));
        ...
        testReader.initialize(new NumberedFileInputSplit(baseDir.getAbsolutePath() + "/twoColumnBuangOutlierSmallTrain%d.csv", 0, 0));
