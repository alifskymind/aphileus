...
@PageTitle("Chart for device 23")
@Route(value = "splineDevice23ChartView")
@PermitAll
public class SplineDevice23ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice23ChartView() {
		...
		configuration.getTitle().setText("Device 23 b83d6160-79b3-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice23Temperature()) {
