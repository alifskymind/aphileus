...
@PageTitle("Chart for device 3")
@Route(value = "splineDevice3ChartView")
@PermitAll
public class SplineDevice3ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice3ChartView() {
		...
		configuration.getTitle().setText("Device 3 dd2361c0-7a3d-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice3Temperature()) {
