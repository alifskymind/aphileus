...
@PageTitle("Chart for device 15")
@Route(value = "splineDevice15ChartView")
@PermitAll
public class SplineDevice15ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice15ChartView() {
		...
		configuration.getTitle().setText("Device 15 f7c343a0-7f16-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice15Temperature()) {
