...
@PageTitle("Chart for device 22")
@Route(value = "splineDevice22ChartView")
@PermitAll
public class SplineDevice22ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice22ChartView() {
		...
		configuration.getTitle().setText("Device 22 b83d6160-79b3-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice22Temperature()) {
