...
@PageTitle("Chart for device 2")
@Route(value = "splineDevice2ChartView")
@PermitAll
public class SplineDevice2ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice2ChartView() {
		...
		configuration.getTitle().setText("Device 2 d9ecefa0-7596-11eb-9a00-990696af4838 Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice2Temperature()) {
