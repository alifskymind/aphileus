...
@PageTitle("Chart for device 16")
@Route(value = "splineDevice16ChartView")
@PermitAll
public class SplineDevice16ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice16ChartView() {
		...
		configuration.getTitle().setText("Device 16 40d1c390-7fe5-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice16Temperature()) {
