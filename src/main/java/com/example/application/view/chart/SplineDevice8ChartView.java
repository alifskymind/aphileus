...
@PageTitle("Chart for device 8")
@Route(value = "splineDevice8ChartView")
@PermitAll
public class SplineDevice8ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice8ChartView() {
		...
		configuration.getTitle().setText("Device 8 50a34050-8e40-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice8Temperature()) {
