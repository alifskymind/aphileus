...
@PageTitle("Chart for device 14")
@Route(value = "splineDevice14ChartView")
@PermitAll
public class SplineDevice14ChartView extends VerticalLayout {

	MenubarView menu = new MenubarView();

	public SplineDevice14ChartView() {
		...
		configuration.getTitle().setText("Device 14 3e682450-7fea-11ec-a439-89feef661f3b Temperature");
		configuration.getTooltip().setEnabled(true);
		configuration.setPlotOptions(plotOptions);

		DataSeries dataSeries = new DataSeries();

		for (JsonDataFetcherController.TemperatureData  data: JsonDataFetcherController.fetchDevice14Temperature()) {
